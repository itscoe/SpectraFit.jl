...
Get the prior distribution of the ith parameter of the isotropic chemical shift interaction
...
Get the estimated powder pattern (a vector of N frequencies) given the isotropic chemical shift interaction
