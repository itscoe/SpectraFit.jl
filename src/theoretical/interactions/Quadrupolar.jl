...
@inline function get_ν1(νQ::typeof(1.0u"MHz"), η::Float64, μ::Float64, 
    λ::Float64, m::FPOT)
    return νQ * Float64(m - FPOT(1, 1)) * (-3μ^2 + ((μ^2 - 1)λ)η + 1)
end
...
@inline function get_ν2(νQ::typeof(1.0u"MHz"), η::Float64, μ::Float64, 
    ...
    return νQ^2 * (Float64(FPOT(1, 1) * (I + FPOT(3, 1)) * (I - FPOT(1, 1)) - 
...
@inline function get_ν3(νQ::typeof(1.0u"MHz"), η::Float64, μ::Float64, 
    λ::Float64, m::FPOT, I::FPOT)
    return νQ^3 * Float64(m - FPOT(1, 1)) * (
...
function estimate_static_powder_pattern(
    ...
    return get_ν1.(νQs, ηs, μs, λs, ms) ./ (2 * ν_step) .+ 
        get_ν2.(νQs, ηs, μs, λs, ms, I₀) ./ (72 * ν₀ * ν_step) .+
        get_ν3.(νQs, ηs, μs, λs, ms, I₀) ./ (144 * ν₀^2 * ν_step)
end
