...
@inline Base.:+(a::FPOT, b::FPOT) = a.d == b.d ? FPOT(a.n + b.n, a.d) : 
    FPOT(a.n * (Int8(1) << b.d) + b.n * (Int8(1) << a.d), a.d + b.d)
@inline Base.:+(a::FPOT, b::Int64) = FPOT(a.n + b * (Int8(1) << a.d), a.d)
@inline Base.:+(a::FPOT, ::Val{1}) = FPOT(a.n + Int8(1) << a.d, a.d)
@inline Base.:+(a::FPOT, ::Val{FPOT(3, 1)}) = a.d == 1 ? FPOT(a.n + 3, a.d) : 
    FPOT(a.n * Int8(2) + 3 * (Int8(1) << a.d), a.d + 1)
...
@inline Base.:-(a::FPOT, b::FPOT) = 
    a.d == b.d ? FPOT(a.n - b.n, a.d) : 
                 FPOT(a.n * (Int8(1) << b.d) - b.n * (Int8(1) << a.d), a.d + b.d)
@inline Base.:-(a::FPOT, b::Int64) = FPOT(a.n - b * (Int8(1) << a.d), a.d)
@inline Base.:-(b::Int64, a::FPOT) = FPOT(b * (Int8(1) << a.d) - a.n, a.d)
@inline Base.:-(a::FPOT, ::Val{1}) = FPOT(a.n - (Int8(1) << a.d), a.d)
@inline Base.:-(a::FPOT, ::Val{FPOT(1, 1)}) = a.d == 0x01 ? 
    FPOT(a.n + Int8(1), a.d) : 
    FPOT(a.n * 0x02 - (Int8(1) << a.d), a.d + 1)
...
Base.:<=(a::FPOT, b::FPOT) = a.d == b.d ? a.n <= b.n : Float64(a) <= Float64(b)
Base.:<(a::FPOT, b::Int64) = a.d == 0x00 ? a.n < b : Float64(a) < b
Base.:<(b::Int64, a::FPOT) = a.d == 0x00 ? b < a.n : b < Float64(a)
Base.:<=(a::FPOT, b::Int64) = a.d == 0x00 ? a.n <= b : Float64(a) <= b
Base.:<=(b::Int64, a::FPOT) = a.d == 0x00 ? b <= a.n : b <= Float64(a)

# Rounding
Base.round(a::SpectraFit.FPOT, _::RoundingMode{:Down}) = 
    FPOT(a.n ÷ (Int8(1) << a.d), 0x00)