...
function get_ν(
    ...
    c = (0.5 * ((I + 3 / 2) * (I - 1 / 2) - 3 * (m - 1 / 2)^2)) *
        (μ4 * (3 - η * λ)^2 + 2 * μ2 * (-9 + 2 * η2 - η2 * λ2) +
         (3 + η * λ)^2) +
        (4 * ((I + 3 / 2) * (I - 1 / 2) - 6 * (m - 1 / 2)^2)) *
        (μ4 * (3 - η * λ)^2 + μ2 * (-9 + η2 + 6 * η * λ - 2 * η2 * λ2) +
         (-(η2) + η2 * λ2))
    e = (12 * I * (I + 1) - 40 * m * (m - 1) - 27) * (μ6 * (3 - η * λ)^3 +
         μ4 * (-36 + 3 * η2 + 42 * η * λ - η3 * λ - 19 * η2 * λ2 +
          3 * η3 * λ3) +
         μ2 * (9 - 4 * η2 - 15 * η * λ + 2 * η3 * λ + 11 * η2 * λ2 -
          3 * η3 * λ3) +
         (η2 - η3 * λ - η2 * λ2 + η3 * λ3)) +
        (1 / 2 * (3 * I * (I + 1) - 5 * m * (m - 1) - 6)) *
        (μ6 * (3 - η * λ)^3 +
         μ4 * (-63 + 12 * η2 + 33 * η * λ - 4 * η3 * λ - 13 * η2 * λ2 +
          3 * η3 * λ3) +
         μ2 *
         (45 - 4 * η2 - 9 * η * λ + 4 * η3 * λ - η2 * λ2 - 3 * η3 * λ3) +
         (-9 + 3 * η * λ + 5 * η2 * λ2 + η3 * λ3)) +
        (8 * I * (I + 1) - 20 * m * (m - 1) - 15) * (μ6 * (3 - η * λ)^3 +
         μ4 * (-54 + 9 * η2 + 36 * η * λ - 3 * η3 * λ - 15 * η2 * λ2 +
          3 * η3 * λ3) +
         μ2 * (27 - 6 * η2 - 9 * η * λ + 4 * η3 * λ + 3 * η2 * λ2 -
          3 * η3 * λ3) +
         (-3 * η2 - η3 * λ + 3 * η2 * λ2 + η3 * λ3))
